...
/*TODO on peut tjrs faire un appel ajax en cas d'erreur*/
    ...
    $file = fopen("../../data/loginEleves.csv","a");      //on rajoute les infos de l'utilisateur modifiées a la fin
    ...
    $list = array($_POST['prenom'], $_POST['nom'], $_POST['email'], $_POST['pseudo'], $_SESSION['password'], "eleves", $_SESSION["pp"]);
    fputcsv($file, $list, ";");
    fclose($file);
